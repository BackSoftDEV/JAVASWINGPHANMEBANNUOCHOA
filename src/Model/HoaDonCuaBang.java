...
public class HoaDonCuaBang {
    ...
    String tensp,ngaysuahd,ngaysuasp,trangthaihd,trangthaisp;
    ...
    public HoaDonCuaBang(int masp,  String tensp,String trangthaisp, Date ngaytaosp, String ngaysuasp,int mahdct, int soluong, int dongia, int tongtien) {
    ...
    public String getNgaysuasp() {
        return ngaysuasp;
    }

    public void setNgaysuasp(String ngaysuasp) {
        this.ngaysuasp = ngaysuasp;
    }
    ...
    public Object[] toDatarow() {
        return new Object[]{this.maHd, this.makh, this.manv, this.mahdct,this.trangthaihd, this.ngaytaohd,this.ngaysuahd,this.masp,this.tensp,this.trangthaisp,this.ngaytaosp,this.ngaysuasp,this.soluong,this.dongia,this.tongtien };
    }
    public Object[] toData() {
        return new Object[]{this.mahdct,this.masp,this.tensp,this.soluong,this.dongia,this.tongtien };
    }
}
